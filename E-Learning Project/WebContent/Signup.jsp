...
<h2><center>Signup Form</center></h2><br></br>
 ...
 <div class="col-md-6" >
<form onsubmit="return validatelogin()" class="for" action="Signup">
...
<div class="form-group input-group">
            <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
            <input class="form-control" type="email" name='email' placeholder="email" id="n1"/>
